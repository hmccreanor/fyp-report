...
We use the results of our investigations to evaluate the potential benefits of such an optimisation.
...
Finally, I wish to thank my flatmates, Adam Maltby, Cameron Fraser, and Om Singh, as well as my parents, Peter and Annie, and sisters, Harriet, Ingrid and Agnes for their unwavering support and encouragement.
%\clearpage{\pagestyle{empty}\cleardoublepage}
...
In each of these approaches, extra compute is used to generate or score more candidate outputs - potentially improving answer quality without retraining.
