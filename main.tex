...
We use the results of these experiments to propose a decode-aware speculative tree expansion optimisation that seeks to make use of differences in optimal batching strategies between the LLM and PRM.
\end{comment}
