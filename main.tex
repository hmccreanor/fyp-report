...
\begin{comment}
  - Again, redo this section so that it is more focused on how I am modifying llms for a specific use case, rather than building my own runtime from scratch
\end{comment}
...
\begin{comment}
  ...
  - I should also detail all the optimisations done by marcel + otto for posterity
